...
class DashHubPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._workspace_action_buttons = [
            self._make_dashboard_action_button(
                self._plugin_name("clip_snip", "Clip Snip"),
                "clipboard",
                lambda: self._open_plugin("clip_snip"),
            ),
            self._make_dashboard_action_button(
            ...
            self._make_dashboard_action_button(
                self._plugin_name("command_center", "Command Center"),
                "settings",
                self._open_settings,
            ),
            self._make_dashboard_action_button(
    ...
    def _open_settings(self) -> None:
        ...
        if main_window is not None:
            main_window.open_command_center()
